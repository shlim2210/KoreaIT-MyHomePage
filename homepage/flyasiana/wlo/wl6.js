 ...
 *
 *  WiseLog Online Version 6.0.4.6 wlo2
 **/
if(typeof(_n_p02) == "undefined") {					  /*  asiana default �����ڵ� */
        _n_p02 = "KR_etc";
}

if(typeof(_n_p03) == "undefined") {					  /*  asiana default �����ڵ� */
        _n_p03 = "etc";
}
_n_p02=_n_p02.toUpperCase();
_n_p03=_n_p03.toUpperCase();
...
var _n_sid = location.hostname;					/* log directory */
 _n_sid = "TF." + _n_p02 +"."+ _n_sid;						/*  asiana  log directory  ������ �α׵��丮 ����*/

if(typeof(loggingCustomSid) != "undefined") {   /* custom log directory */
        _n_sid = loggingCustomSid;
}

var broswerInfo = navigator.userAgent;		/*  userAgent ���Ͽ� flyasianaAPP �̶�� ���� ���̸� sid���� app�� ����. */
if(broswerInfo.indexOf("flyasianaAPP")>-1){
    _n_sid = "appweb." + _n_sid;
	_n_p01= "APP";										/*  asiana  webview �� �÷��� APP���� ����*/
}

var _n_ls = "http://weblog.flyasiana.com/wlo/Logging";		    /* logging server */
var _n_uls = "http://weblog.flyasiana.com/wlo/UserLogging";	/* user logging server */
...
if ( document.location.protocol == "https:" ) {
	_n_ls = "https://weblog.flyasiana.com/wlo/Logging";
	_n_uls = "https://weblog.flyasiana.com/wlo/UserLogging";
}
...
var action_logging = function(param) {
	...
	//var action_url="";
	//action_url = (click_logging_stem + "?_n_p01=" + _n_p01 + "&_n_p02=" + _n_p02 + "&_n_p03=" + _n_p03 + "&" + click_logging_param;
	//action_url = n_encodeStr2(action_url);
	//n_click_logging(action_url,location.href);
	n_click_logging(click_logging_stem + "?_n_p01=" + _n_p01 + "&_n_p02=" + _n_p02 + "&_n_p03=" + _n_p03 + "&" + click_logging_param,location.href);
...
function n_Logging_M() {
		...
		if ( (typeof _n_m11)!="undefined" && _n_m11 ) { n_setCustomParam("_n_m11", _n_m11); }
		if ( (typeof _n_m12)!="undefined" && _n_m12 ) { n_setCustomParam("_n_m12", _n_m12); }
		if ( (typeof _n_m13)!="undefined" && _n_m13 ) { n_setCustomParam("_n_m13", _n_m13); }
		if ( (typeof _n_m14)!="undefined" && _n_m14 ) { n_setCustomParam("_n_m14", _n_m14); }
		if ( (typeof _n_m15)!="undefined" && _n_m15 ) { n_setCustomParam("_n_m15", _n_m15); }
		if ( (typeof _n_m16)!="undefined" && _n_m16 ) { n_setCustomParam("_n_m16", _n_m16); }
		if ( (typeof _n_m17)!="undefined" && _n_m17 ) { n_setCustomParam("_n_m17", _n_m17); }
		if ( (typeof _n_m18)!="undefined" && _n_m18 ) { n_setCustomParam("_n_m18", _n_m18); }
}
/* @Deprecated 7.0.1.1 */
function n_Logging_P() {
		...
		if ( (typeof _n_p11)!="undefined" && _n_p11 ) { n_setCustomParam("_n_p11", _n_p11); }
		if ( (typeof _n_p12)!="undefined" && _n_p12 ) { n_setCustomParam("_n_p12", _n_p12); }
		if ( (typeof _n_p13)!="undefined" && _n_p13 ) { n_setCustomParam("_n_p13", _n_p13); }
		if ( (typeof _n_p14)!="undefined" && _n_p14 ) { n_setCustomParam("_n_p14", _n_p14); }
		if ( (typeof _n_p15)!="undefined" && _n_p15 ) { n_setCustomParam("_n_p15", _n_p15); }
		if ( (typeof _n_p16)!="undefined" && _n_p16 ) { n_setCustomParam("_n_p16", _n_p16); }
		if ( (typeof _n_p17)!="undefined" && _n_p17 ) { n_setCustomParam("_n_p17", _n_p17); }
		if ( (typeof _n_p18)!="undefined" && _n_p18 ) { n_setCustomParam("_n_p18", _n_p18); }
		if ( (typeof _n_p19)!="undefined" && _n_p19 ) { n_setCustomParam("_n_p19", _n_p19); }
		if ( (typeof _n_p20)!="undefined" && _n_p20 ) { n_setCustomParam("_n_p20", _n_p20); }
		if ( (typeof _n_p21)!="undefined" && _n_p21 ) { n_setCustomParam("_n_p21", _n_p21); }
		if ( (typeof _n_p22)!="undefined" && _n_p22 ) { n_setCustomParam("_n_p22", _n_p22); }
		if ( (typeof _n_p23)!="undefined" && _n_p23 ) { n_setCustomParam("_n_p23", _n_p23); }
		if ( (typeof _n_p24)!="undefined" && _n_p24 ) { n_setCustomParam("_n_p24", _n_p24); }
		if ( (typeof _n_p25)!="undefined" && _n_p25 ) { n_setCustomParam("_n_p25", _n_p25); }
		if ( (typeof _n_p26)!="undefined" && _n_p26 ) { n_setCustomParam("_n_p26", _n_p26); }
		if ( (typeof _n_p27)!="undefined" && _n_p27 ) { n_setCustomParam("_n_p27", _n_p27); }
		if ( (typeof _n_p28)!="undefined" && _n_p28 ) { n_setCustomParam("_n_p28", _n_p28); }
		if ( (typeof _n_p29)!="undefined" && _n_p29 ) { n_setCustomParam("_n_p29", _n_p29); }
		if ( (typeof _n_p30)!="undefined" && _n_p30 ) { n_setCustomParam("_n_p30", _n_p30); }
		if ( (typeof _n_p31)!="undefined" && _n_p31 ) { n_setCustomParam("_n_p31", _n_p31); }
		if ( (typeof _n_p32)!="undefined" && _n_p32 ) { n_setCustomParam("_n_p32", _n_p32); }
		if ( (typeof _n_p33)!="undefined" && _n_p33 ) { n_setCustomParam("_n_p33", _n_p33); }
		if ( (typeof _n_p34)!="undefined" && _n_p34 ) { n_setCustomParam("_n_p34", _n_p34); }
		if ( (typeof _n_p35)!="undefined" && _n_p35 ) { n_setCustomParam("_n_p35", _n_p35); }
}
